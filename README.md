...
* Windows 경우
    ...
    3. Putty 실행 &rightarrow; **Host Name** = [EC2 Instance Public IP]
...
2. S3 Dashboard에서  **[Create bucket]** 클릭후, **Bucket name** = [DOMAIN_NAME] i.e. woo.saltware.io, **Region** = Asia Pacific (Seoul), **[Create]** 클릭
